...
class MemberCertificateScreen extends StatelessWidget {
  const MemberCertificateScreen({super.key});
                ...
                children: [
                  ...
                  Container(
                    ...
                    decoration: BoxDecoration(
                      color: AppColors.secondaryPurple.withAlpha(20),
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        Expanded(
                          child: Text(
                            'Certificate requests are reviewed by your assigned admin and Super Admin',
                            style: GoogleFonts.poppins(
      ...
      child: Row(
        children: [
          Container(
            ...
            height: 44,
            decoration: BoxDecoration(
              color: AppColors.secondaryPurple.withAlpha(25),
              borderRadius: BorderRadius.circular(10),
            ),
    ...
    return Center(
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 8),
          Text('Tap "+ Request Certificate" to get started',
              style: GoogleFonts.poppins(
